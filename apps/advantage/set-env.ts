...
const envConfigFile = `export const environment = {
    ...
    terminologiesAndTariffsUrl: '${process.env.NG_APP_TERMINOLOGIES_AND_TARIFFS_SERVER_URL}',
    ...
    biometricsHardwareServerUrl: '${process.env.NG_APP_BIOMETRICS_HARDWARE_SERVER_URL}',
    biometricsHardwareServerStatusCheckTimeoutInMs: '${process.env.NG_APP_BIOMETRICS_HARDWARE_STATUS_CHECK_TIMEOUT_IN_MS}',
    biometricsMidlewareServiceUrl: '${process.env.NG_APP_BIOMETRICS_MIDDLEWARE_SERVICE_URL}',
    ...
    supersetDashboardUuids: '${process.env.NG_APP_SUPERSET_DASHBOARD_UUIDS}',
    keycloak: {
    ...
    empowerClarityProjectId: '${process.env.NG_APP_EMPOWER_CLARITY_PROJECT_ID}',
...
let sourcePath = `./apps/advantage/src/manifest-variants/manifest.${process.env.NG_APP_VARIANT}.json`;
...
sourcePath = `./apps/advantage/src/assets/icons/${process.env.NG_APP_VARIANT}/favicon.png`;
