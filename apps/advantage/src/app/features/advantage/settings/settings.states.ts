...
import { OrganisationUnitsComponent } from '../../healthcrm/organisations/organisation-units/organisation-units.component';
 ...
 */
export const orgClusterState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.clusters',
    url: '/clusters',
    breadcrumb: () => 'Clusters',
    data: {
        requiresAuth: true,
        ...
        actions: [
            {
                ...
                action: 'stateGo',
                modalConf: {
                    state: 'app.advantage.settings.orglevel.clusters.detail',
                },
            },
        ],

        extraPayload: { orgunit_type: 'cluster' },
    },
    resolve: [
        {
            token: 'store',
    ...
    views: {
        'detail@app.advantage.settings.orglevel': {
 ...
 */
export const orgClusterDetailsState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.clusters.detail',
    url: '/view/:id',
    redirectTo: 'app.advantage.settings.orglevel.clusters.detail.basic',
    ...
    resolve: [
        {
            token: 'clusterObservable',
            deps: [ResolverService, Transition],
            resolveFn: (resolveSvc, transition) =>
                resolveSvc.resolveItem('clusters', transition.params().id),
        },
    ],
    bindings: {
        resolveData: 'clusterObservable',
    },
    views: {
        '$default@app.advantage': {
            component: ClusterDetailsBannerComponent,
        },
    },
};
 ...
 */
export const orgClusterBasicDetailsState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.clusters.detail.basic',
    url: '/basic',
    ...
    views: {
        'detail@app.advantage.settings.orglevel.clusters.detail': {
 ...
 */
export const orgClusterBranchesState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.clusters.detail.branches',
    url: '/branches?search&page',
    breadcrumb: () => 'Branches',
    data: {
        requiresAuth: true,
    },
    views: {
        'detail@app.advantage.settings.orglevel.clusters.detail': {
            component: ClusterBranchesComponent,
        },
    },
};
 ...
 */
export const orgBranchState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.branches',
    url: '/branches',
    breadcrumb: () => 'Branches',
    data: {
        requiresAuth: true,
                ...
                nested: [
                    {
                        key: 'etims_branch_id',
                        label: 'Branch ID',
                        value: 'etims_branch_id',
                        type: 'string',
                    },
                    {
                        key: 'etims_device_serial_no',
                        label: 'Serial No',
                        value: 'etims_device_serial_no',
                        type: 'string',
                    },
                    {
                        key: 'is_etims_verified',
                        label: 'Device Initialized',
                        value: 'is_etims_verified',
                        type: 'boolean',
                    },
                ],
            },
        ...
        actions: [
            {
                ...
                action: 'stateGo',
                modalConf: {
                    state: 'app.advantage.settings.orglevel.branches.detail',
                },
            },
        ],
        extraPayload: { orgunit_type: 'branch' },
    },
    resolve: [
        {
            token: 'store',
 ...
 */
export const orgBranchDetailsState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.branches.detail',
    url: '/view/:id',
    redirectTo: 'app.advantage.settings.orglevel.branches.detail.basic',
    ...
    data: {
                ...
                nested: [
                    {
                        ...
                        type: 'string',
                        label: 'KRA PIN',
                        value: 'customer_tax_pin',
                    },
                    {
                        key: 'customer_sync_to_etims',
                        type: 'boolean',
                        label: 'Sent to eTIMS',
                        value: 'customer_sync_to_etims',
                    },
                ],
            },
            {
        ...
        etimsTableHeader: [
            { text: 'Customer Name' },
            { text: 'Customer Type' },
            { text: 'Customer KRA PIN' },
            { text: 'Customer Contacts' },
            { text: 'Action' },
        ],
        filterParams: {
            fields: 'id,partner_name,customer_type,country,currency,customer_tax_pin,phone_number,email_address,customer_sync_to_etims',
            page_size: 10,
        },
        actions: [
            {
                ...
                action: 'modal',
                modalConf: {
                    store: 'updateOrgBranchCustomerService',
                    isService: true,
                    context: 'Edit Branch Customer',
                    action: 'quickPatch',
                    httpMethod: 'update',
                    api: 'customers',
                    method: 'genericPatch',
                    successTitle: 'Edit Branch Customer',
                    successMessage: 'Branch Customer Edited',
                    failedTitle: 'Edit Branch Customer',
                    failedMessage: 'Branch Customer updating has failed',
                },
            },
        ],
    },
    resolve: [
        {
            token: 'branchObservable',
            deps: [ResolverService, Transition],
            resolveFn: (resolveSvc, transition) =>
                resolveSvc.resolveItem('branches', transition.params().id),
        },
    ],
    bindings: {
        resolveData: 'branchObservable',
    },
    views: {
        '$default@app.advantage': {
            component: BranchDetailsBannerComponent,
        },
    },
};
 ...
 */
export const orgBranchBasicDetailsState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.branches.detail.basic',
    url: '/basic',
    breadcrumb: () => 'Basic Details',
    data: {
        requiresAuth: true,
    ...
    views: {
        'detail@app.advantage.settings.orglevel.branches.detail': {
 ...
 */
export const orgBranchCustomersState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.branches.detail.customers',
    url: '/customers?search&page&customer_type',
    ...
    views: {
        'detail@app.advantage.settings.orglevel.branches.detail': {
            component: BranchCustomersComponent,
        },
    },
};
 ...
 */
export const orgDeptState: Ng2StateDeclaration = {
    name: 'app.advantage.settings.orglevel.departments',
    url: '/departments',
    ...
    data: {
        ...
        extraPayload: { orgunit_type: 'dept' },
    },
    resolve: [
        {
            token: 'store',
            resolveFn: () => 'departments',
        },
        {
            token: 'storeLabel',
...
export const SETTING_STATES = [
    ...
    currencyState,
    orgBranchState,
    orgBranchDetailsState,
    orgBranchBasicDetailsState,
    orgBranchCustomersState,
    orgClusterState,
    orgClusterDetailsState,
    orgClusterBasicDetailsState,
    orgClusterBranchesState,
    orgDeptState,
    productsState,
