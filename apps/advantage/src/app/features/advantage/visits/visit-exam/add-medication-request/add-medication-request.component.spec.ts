...
import { AddMedicationRequestComponent } from './add-medication-request.component';
import {
...
describe('AddMedicationRequestComponent fails', () => {
    let component: AddMedicationRequestComponent;
    let fixture: ComponentFixture<AddMedicationRequestComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [AddMedicationRequestComponent],
        ...
        fixture = TestBed.createComponent(AddMedicationRequestComponent);
    ...
    it('should test submitPrescription', () => {
        const event = {
            dose_unit: '',
        };
        spyOn(component, 'submitPrescription').and.callThrough();
        component.getFormOptions({ resetModel: () => {} });
        component.submitPrescription(event);
        expect(component.submitPrescription).toHaveBeenCalledWith(event);
    });
});
