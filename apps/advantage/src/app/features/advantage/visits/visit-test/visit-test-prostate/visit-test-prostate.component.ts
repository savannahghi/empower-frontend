...
@Component({
    selector: 'ngx-visit-test-prostate',
    imports: [
        CommonModule,
        ThemeModule,
        NbButtonModule,
    ...
    templateUrl: './visit-test-prostate.component.html',
    styleUrls: ['./visit-test-prostate.component.scss'],
})
export class VisitTestProstateComponent
    ...
    implements OnInit
{
    ...
    recordResults() {
        ...
        const handleRecordTest = (payloadObj: any) => {
            this.dataLayer.create('tests', payloadObj).subscribe({
                next: () => {
        ...
        const payload: any = {
            ...
            testType: 'WHOLE_BLOOD',
        };

        switch (selectedOptions.selected_test) {
            case 'Prostate Specific Antigen - Serum':
                handleRecordTest({
                    input: {
                        encounterID: this.encounterId,
                        note: selectedOptions.additional_notes,
                    ...
                    testType: 'PROSTATIC_SERUM_ANTIGEN',
                });
                break;
            case 'Prostate Specific Antigen - Whole Blood':
                handleRecordTest(payload);
                break;
            default:
                this.showToastError(
                    'bottom-right',
