...
import { VisitTestCervicalComponent } from './visit-test-cervical.component';
...
describe('VisitTestCervicalComponent', () => {
    let component: VisitTestCervicalComponent;
    let fixture: ComponentFixture<VisitTestCervicalComponent>;
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(VisitTestCervicalComponent);
    ...
    it('should test recordResults for HPV PCR DNA', () => {
        spyOn(component, 'recordResults').and.callThrough();
        component.isFormFilled = true;
        component.formData = {
            selected_test: 'HPV PCR DNA',
            selected_result: 'Positive',
        };
    ...
    it('should test recordResults for HPV Oncoprotein', () => {
        spyOn(component, 'recordResults').and.callThrough();
        component.isFormFilled = true;
        component.formData = {
            selected_test: 'HPV Oncoprotein',
            selected_result: 'Positive',
        };
...
describe('VisitTestCervicalComponent with an error response', () => {
    let component: VisitTestCervicalComponent;
    let fixture: ComponentFixture<VisitTestCervicalComponent>;
    ...
    it('should test the handleApiError function', () => {
        ...
        component.handleApiError(mockErrorResponse);
        expect(component.savingResult).toBeFalse();
    ...
    it('should test handleRecordExamination on dataLayer error', () => {
        component.formData = {
            selected_test: 'VIA',
            referral_notes: 'some notes',
            selected_result: 'positive',
