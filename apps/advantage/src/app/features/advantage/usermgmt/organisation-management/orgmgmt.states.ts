...
export const setupUsersState: Ng2StateDeclaration = {
    ...
    data: {
        ...
        actions: [
            ...
            },
            {
                ...
                modalConf: {
                    ...
                    method: 'genericPost',
                    // No mail is sent, so the new password has to be read off
                    // the response for the administrator to pass on.
                    dataTitle: 'New password',
                    dataMessage: 'temporary_password',
        ...
        hasSearch: true,
        formlyJsonFilename: 'register-user',
    },
...
export const setupUsersDetailBasicState = {
    ...
    resolve: [
        {
            ...
            resolveFn: (resolveSvc: any, transition: any) => {
                ...
                const userEmail = transition.params().email;
                return resolveSvc.resolveItem('user-details-hermes', userId, {
                    email: userEmail,
                });
            },
        },
    ...
    bindings: {
        recordObservable: 'recordObservable',
    },
    views: {
...
export const roleDetailsState: Ng2StateDeclaration = {
    ...
    redirectTo: 'app.advantage.usermgmt.roles.detail.basic',
};
