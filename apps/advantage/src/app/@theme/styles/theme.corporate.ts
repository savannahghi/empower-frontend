...
/**
 * baseTheme contains thr base theme variables
 */
const baseThemeVariables = baseTheme.variables;

/**
 * This contains the variables for the corporate theme in Nebular.
 * To override the theme options, it is done from here
 */
