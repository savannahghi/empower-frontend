...
import { ProstateCancerExaminationsService } from './prostate-cancer-examinations-form';
import {
    provideHttpClient,
...
describe('ProstateCancerExaminationsServiceForm', () => {
    let service: ProstateCancerExaminationsService;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            providers: [
                ...
                ProstateCancerExaminationsService,
                DataLayerUtils,
                Oauth2Service,
                AppConfigService,
                {
        ...
        service = TestBed.inject(ProstateCancerExaminationsService);
    });
