...
import { NewReturnOutwardsRecordFieldsService } from './new-return-outwards-record-form';
import {
    provideHttpClient,
...
describe('', () => {
    let service: NewReturnOutwardsRecordFieldsService;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [mockPipe('translate')],
            providers: [
                NewReturnOutwardsRecordFieldsService,
                SilCurrencyPipe,
        ...
        service = TestBed.inject(NewReturnOutwardsRecordFieldsService);
    });
