...
import { AddSupplierPaymentRunLineFormService } from './add-supplier-payment-runline-form';
...
describe('AddSupplierPaymentRunLineFormService', () => {
    let service: AddSupplierPaymentRunLineFormService;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [],
            providers: [
                AddSupplierPaymentRunLineFormService,
                { provide: SilStoresService, useClass: SilStoresServiceStub },
                provideHttpClient(withInterceptorsFromDi()),
                provideHttpClientTesting(),
            ],
        });
        service = TestBed.inject(AddSupplierPaymentRunLineFormService);
    });
