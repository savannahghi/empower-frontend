...
/**
 * Class for the form prostate cancer screening service
 */
export class ProstateCancerScreeningService {
    /**
                ...
                fieldGroup: [
                    ...
                    },
                    {
                        ...
                        props: {
                            ...
                            options: [
                                {
                                    value: 'Prostate Specific Antigen - Serum',
                                },
                                {
                                    value: 'Prostate Specific Antigen - Whole Blood',
                                },
                            ],
                        },
                        expressions: {
