...
import { AddExamDiagnosisFormService } from './add-exam-diagnosis-form';
import {
    provideHttpClient,
...
describe('AddExamDiagnosisFormServiceFieldsForm', () => {
    let service: AddExamDiagnosisFormService;
    ...
    beforeEach(() => {
        ...
        service = TestBed.inject(AddExamDiagnosisFormService);
    });
    ...
    it('should test fields and observable functions', () => {
        ...
        fields[1]['expressions']['model.description'](field);
