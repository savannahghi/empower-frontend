...
import { NewPaymentMethodFieldsService } from './new-payment-method-form';
...
describe('', () => {
    let service: NewPaymentMethodFieldsService;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [mockPipe('translate')],
            providers: [
                NewPaymentMethodFieldsService,
                SilCurrencyPipe,
        ...
        service = TestBed.inject(NewPaymentMethodFieldsService);
    });
    ...
    it('should test fields and observable functions', () => {
        ...
        fields[1]['model.effective_from'] = field1;
