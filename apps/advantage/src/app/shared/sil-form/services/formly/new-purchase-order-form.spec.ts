...
import { NewPurchaseOrderFieldsService } from './new-purchase-order-form';
import {
    provideHttpClient,
...
const uIRouterGlobalsStub = {
    ...
    params: { appointment_id: 1, pricelist: 1 },
    $current: {
        is: () => true,
        params: { appointment_id: 1, pricelist: 1 },
    },
...
describe('', () => {
    let service: NewPurchaseOrderFieldsService;

    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [mockPipe('translate')],
            providers: [
                NewPurchaseOrderFieldsService,
                SilCurrencyPipe,
        ...
        service = TestBed.inject(NewPurchaseOrderFieldsService);
    });
    ...
    it('should test fields and observable functions', () => {
        ...
        fields[1]['model.quantity'] = field1;

        expect(service.fields).toHaveBeenCalled();
    });

    it('should test pricelist id', () => {
        uIRouterGlobalsStub.params = { pricelist: '1' } as any;
        const comp = {
            model: {},
            fields: [
                {},
        ...
        expect(service.pricelist).toEqual('1');
    });

    it('should test pricelist id undefined params', () => {
        uIRouterGlobalsStub.params = undefined as any;
        const comp = {
            model: {},
            fields: [
                {},
        ...
        expect(service.pricelist).toBeUndefined();
    });
});
