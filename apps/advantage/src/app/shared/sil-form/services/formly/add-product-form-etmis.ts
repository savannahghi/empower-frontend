 ...
 */
export class EtimsProductFieldsService {
    /**
        ...
        return [
            {
                ...
                expressions: {
                    ...
                    'model.slade_code': field => {
                        if (field?.model?.slade_code) {
                            return field.model.slade_code;
                        }
                    },
                },
    ...
    setComponent(component) {
        ...
        if (
            ...
            this.component.secondaryData.length > 0
        ) {
