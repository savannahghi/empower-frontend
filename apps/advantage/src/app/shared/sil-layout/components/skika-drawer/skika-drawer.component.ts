 ...
 */
@Component({
    selector: 'skika-drawer',
    styleUrls: ['./skika-drawer.component.scss'],
    templateUrl: './skika-drawer.component.html',
    standalone: false,
})
 ...
 */
export class SkikaDrawerComponent {
    /**
